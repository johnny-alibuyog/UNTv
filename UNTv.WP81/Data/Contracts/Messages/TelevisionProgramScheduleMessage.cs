...
{
    public static class TelevisionProgramScheduleMessage 
    {
        ...
        public class Response
        {
            ...
            public Response()
            {
                this.MondayPrograms = new TelevisionProgramSchedule[] { };
                this.TuesdayPrograms = new TelevisionProgramSchedule[] { };
                this.WednesdayPrograms = new TelevisionProgramSchedule[] { };
                this.ThursdayPrograms = new TelevisionProgramSchedule[] { };
                this.FridayPrograms = new TelevisionProgramSchedule[] { };
                this.SaturdayPrograms = new TelevisionProgramSchedule[] { };
                this.SundayPrograms = new TelevisionProgramSchedule[] { };
            }
            ...
            public virtual ReactiveList<ItemViewModel> AsItems(DayOfWeek day)
            {
                ...
                Func<TelevisionProgramSchedule, string> ChoseFromImages = (x) =>
                    ...
                    ValidateUri(x.BannerThumbnailUri) ? x.BannerThumbnailUri : "/Assets/Images/LightGray.png";

                var programs = GetPrograms();
                if (programs == null || programs.Count() == 0)
                    return null;

                var items = programs.Select(x => new ItemViewModel()
                 {
                     Id = x.Id,
                     Title = x.Title,
