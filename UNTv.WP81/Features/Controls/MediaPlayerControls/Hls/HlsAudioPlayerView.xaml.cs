...
namespace UNTv.WP81.Features.Controls.MediaPlayerControls.Hls
{
    ...
    /// </summary>
    public sealed partial class HlsAudioPlayerView : Page, IViewFor<HlsAudioPlayerViewModel>
    {
        public HlsAudioPlayerView()
        {
        ...
        public static readonly DependencyProperty ViewModelProperty = DependencyProperty
            .Register("ViewModel", typeof(HlsAudioPlayerViewModel), typeof(HlsAudioPlayerView), new PropertyMetadata(null));

        public HlsAudioPlayerViewModel ViewModel
        {
            get { return (HlsAudioPlayerViewModel)GetValue(ViewModelProperty); }
        ...
        object IViewFor.ViewModel
        {
            ...
            set { ViewModel = (HlsAudioPlayerViewModel)value; }
        }
    }
}
