...
namespace UNTv.WP81.Features.News
{
    public class NewsHubViewModel : ReactiveRoutableBase
    {
        ...
        public virtual bool HasEmptyFields 
        {
            get
            {
                return
                    this.Headlines.IsNullOrEmpty() ||
                    this.WorldNews.IsNullOrEmpty() ||
                    this.SportsNews.IsNullOrEmpty() ||
                    this.HealthNews.IsNullOrEmpty() ||
                    this.PoliticalNews.IsNullOrEmpty() ||
                    this.EducationNews.IsNullOrEmpty() ||
                    this.TechnologyNews.IsNullOrEmpty() ||
                    this.GovernmentNews.IsNullOrEmpty() ||
                    this.ProvincialNews.IsNullOrEmpty() ||
                    this.ScienceNews.IsNullOrEmpty();
            }
        }
        ...
        {
            if (this.Headlines.IsNullOrEmpty())
            {
            ...
            if (this.WorldNews.IsNullOrEmpty())
            {
            ...
            if (this.SportsNews.IsNullOrEmpty())
            {
            ...
            if (this.HealthNews.IsNullOrEmpty())
            {
            ...
            if (this.PoliticalNews.IsNullOrEmpty())
            {
            ...
            if (this.EducationNews.IsNullOrEmpty())
            {
            ...
            if (this.TechnologyNews.IsNullOrEmpty())
            {
            ...
            if (this.GovernmentNews.IsNullOrEmpty())
            {
            ...
            if (this.ProvincialNews.IsNullOrEmpty())
            {
            ...
            if (this.ScienceNews.IsNullOrEmpty())
            {
